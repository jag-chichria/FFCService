...
namespace FFCService
{
    public partial class FFCService : ServiceBase
    {
        ...
        String defaultServiceExecuteEvery = "1M";   // 1 Minute       
        public FFCService()
        {
            InitializeComponent();

            //Rakesh, change here if you are maintaining any logging.
        ...
        {
            // You can build the Application settings or you have already, use it here to 
            // to set the value to timer class.
            // below variable serviceExecution expects the value as xH, xM, xS
            // whereas x is any value and H, M, and S denotes Hour, Minute, and Second, respectively.


            // Rakesh, you can either omit below code or you it per BR!
            //ApplicationSettings settings = new ApplicationSettings();
            String serviceExecution = defaultServiceExecuteEvery; // settings.ServiceExecuteEvery;
            double result = 0;
